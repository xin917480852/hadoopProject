package com.xiaoxin.mapreduce.leftjoin;
...
*/
public class LJoin {
    static class LJoinMapper extends Mapper<LongWritable, Text, Text, InfoBean> {
        ...
        static class LJoinReducer extends Reducer<Text, InfoBean, InfoBean, NullWritable> {
...
//		job.setJar("c:/join.jar");
        ...
        job.setJarByClass(LJoin.class);
        // 指定本业务job要使用的mapper/Reducer业务类
        job.setMapperClass(LJoinMapper.class);
        job.setReducerClass(LJoinReducer.class);
